...
CUDA_VISIBLE_DEVICES=0 python main.py --mode test --dataset CelebA --image_size 256 --c_dim 1 \
               ...
               --selected_attrs Male --batch_size 1 --num_iters 350000 --num_iters_decay 350000 \
               ...
               --model_save_step 50000 --lr_update_step 100000 --test_iters 30